          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                title:  Text('Categories',style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.black)),
                onTap: () {
              ...
              ListTile(
                ...
                title:  Text('Settings',style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.black)),
                onTap: () {
